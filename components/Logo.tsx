    ...
    return (
        <div className="relative w-48 h-48">
            ...
            <svg viewBox="0 0 200 200" className="w-full h-full animate-slow-rotate">
                ...
                <g className="animate-spin-clockwise-1" style={{ transformOrigin: '100px 100px' }}>
                    <ellipse cx="100" cy="100" rx="90" ry="35" stroke="#4f4f7f" strokeWidth="2" fill="none" transform="rotate(45 100 100)" />
                </g>
                <g className="animate-spin-counter-clockwise-1" style={{ transformOrigin: '100px 100px' }}>
                     <ellipse cx="100" cy="100" rx="90" ry="35" stroke="#4f4f7f" strokeWidth="2" fill="none" transform="rotate(-45 100 100)" />
                </g>
                <g className="animate-spin-clockwise-2" style={{ transformOrigin: '100px 100px' }}>
