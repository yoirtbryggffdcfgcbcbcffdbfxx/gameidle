...
import QuantumPathUpgradeCard from '../quantum/path/QuantumPathUpgradeCard';
...
const QuantumPathView: React.FC = () => {
    ...
    const { exitQuantumInterface, onPurchasePathUpgrade, onResetQuantumPath } = handlers;
                ...
                <div className="w-full max-w-2xl lg:max-w-screen-2xl mx-auto flex flex-col md:flex-row gap-6 lg:gap-8">
                    ...
                    <div className="w-full md:w-1/3 flex flex-col items-center p-4 bg-black/20 rounded-lg">
                        ...
                        <div className="w-full mt-auto pt-4">
                            <button 
                                onClick={onResetQuantumPath}
                                className="w-full px-4 py-2 bg-red-800/80 text-white rounded transition-colors hover:bg-red-700 active:bg-red-900 border border-red-500/50 text-xs"
                            >
                                Réinitialiser la Voie
                            </button>
                        </div>
                    </div>
...
export default QuantumPathView;