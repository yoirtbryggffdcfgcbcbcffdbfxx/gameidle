...
const UpgradeAction: React.FC<UpgradeActionProps> = ({
    ...
    const getButtonContent = () => {
        ...
        return (
            <div className="flex flex-col items-center">
                <span className={`text-[10px] font-bold ${canAfford ? 'text-black/70' : 'text-white/50'}`}>
                    {hasDiscount ? 'PROMO x1' : 'ACHETER x1'}
                </span>
    ...
    if (isMaxLevel) {
        ...
        stateClasses = "bg-gray-800/50 text-gray-500 border border-gray-700 cursor-not-allowed";
    }
